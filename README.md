...
cd "c:\Users\vansh\OneDrive - MSFT\border project trikon3.0\ml_engine"
# If using a virtual environment, activate it first (e.g., .\.venv\Scripts\activate)
...
cd "c:\Users\vansh\OneDrive - MSFT\border project trikon3.0\ml_engine\frontend"
npm run dev
```
